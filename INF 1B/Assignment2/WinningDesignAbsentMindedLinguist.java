 ...
 * punctuation at the end of a valid sentence. A valid sentence contains: just
 * a verb, a subject and a verb, or a subject, a verb and an object. For each
 * of the 6 permutations of these three elements this class outputs the
 * correct punctuation if the input string can be made into a list of valid
 * sentences for that order./
 */

public class WinningDesignAbsentMindedLinguist
{
    /**
     ...
     */
    public static int indexNotInSentence(ArrayList<Character> characters)
    {
        int index = 0;
            ...
            ArrayList<ArrayList<Character>> possibleStrings)
    {
        for (int k = 0; k < possibleStrings.size(); k++)
        {
            ...
            int startIndex = indexNotInSentence(possibleString);
     ...
     */
    public static HashMap<String, Boolean> setOthersToFalse(String element,
                                                            HashMap<String,
                                                                    Boolean> values)
    {
     ...
     * @return the modified hashmap
     */
    public static HashMap<String, Boolean> setOtherHalfToFalse(String vsOrder,
                                                               HashMap<String
                                                                       ,
                                                                       Boolean> values)
    {
                                                                       ...
                                                                       Boolean> valuesOfPermutations)
    {
        ...
        for (String permutation : permutations)
        {
            ...
            {
                setOthersToFalse(permutation, valuesOfPermutations);
            }
        }
        return valuesOfPermutations;
    }
    ...
    public static void main(String[] args)
    {
        ...
        for (ArrayList<Character> characterList : allValidStrings)
        {
            ...
            {
                valuesOfPermutations = setOtherHalfToFalse("VS",
                        valuesOfPermutations);
            }
            if (string.contains("S, V, ."))
            {
                valuesOfPermutations = setOtherHalfToFalse("SV",
                        valuesOfPermutations);
            }
            ...
            for (String key : valuesOfPermutations.keySet())
            {
                ...
                {
                    System.out.println(key + " = " + characterList);
                }
            }
        }
    }
