# Instructions for the winning design in `designLoser.md` #
...
Outline (not much detail) the key features of this design. Explain
either why you abandoned this before completion, or why you completed
it. Do not repeat the discussion from `designWinner.md`.
