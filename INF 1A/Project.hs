...
prove sequent= getridofduplicates (repeatuntilcantbedone helper (removeimpliesitself sequent))
...
helper sequent    | isnotnot (rightside sequent) = Just [leftside sequent :|=: [nonot (head (rightside sequent ))]]
                  ...
                  | isifonlyif (leftside sequent) = Just [firstif (head (leftside sequent)) :->: secondif (head (leftside sequent)) : secondif (head (leftside sequent)) :->: firstif (head (leftside sequent)) : tail (leftside sequent) :|=: rightside sequent]
                  | containsifonlyif (leftside sequent) = Just [(firstif (head (filter (isifonlyif2) (leftside sequent))) :->: (secondif (head (filter (isifonlyif2) (leftside sequent))))): (secondif (head (filter (isifonlyif2) (leftside sequent))) :->: firstif (head (filter (isifonlyif2) (leftside sequent)))) : filter (/= (head (filter (isifonlyif2 ) (leftside sequent)))) (leftside sequent) :|=: rightside sequent]
                  
                  | isifonlyif (rightside sequent) = Just [firstif (head (rightside sequent)) :->:secondif (head (rightside sequent)) : (leftside sequent) :|=:  secondif (head (rightside sequent)):->: firstif (head (rightside sequent)) : tail (rightside sequent)]
                  ...
                  | isifthen (rightside sequent) = Just [if' (head (rightside sequent)) : (leftside sequent)  :|=:  then' (head (rightside sequent)) : tail (rightside sequent) ]
...
removeimpliesitself :: Sequent -> Sequent
removeimpliesitself sequent | containsa (leftside sequent) = filter (not . aa) (leftside sequent) :|=:  rightside sequent
                            | containsa (rightside sequent) =  leftside sequent:|=: filter (not . aa) (rightside sequent)
                            | otherwise = leftside sequent :|=: rightside sequent

containsa :: [Prop] -> Bool
containsa props = not (null (filter (aa) props))
